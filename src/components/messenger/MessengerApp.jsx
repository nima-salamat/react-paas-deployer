      ...
      {!activeId ? (
        ...
        <>
          ...
          <ChatHeader
            ...
            msgSearchQ={msgSearchQ}
            setMsgSearchQ={setMsgSearchQ}
            msgSearchLoading={msgSearchLoading}
            msgSearchResults={msgSearchResults}
            msgSearchIdx={msgSearchIdx}
            msgSearchLastQRef={msgSearchLastQRef}
            runMessageSearch={runMessageSearch}
            focusCurrentSearchResult={focusCurrentSearchResult}
            goMsgSearchResult={goMsgSearchResult}
            ...
            formatTypingLabel={formatTypingLabel}
          ...
          <MessageTimeline
            listRef={listRef}
            isMobile={isMobile}
            onScrollMsgs={onScrollMsgs}
            onMessagesListPointerDown={onMessagesListPointerDown}
            onMessagesListPointerMove={onMessagesListPointerMove}
            onMessagesListPointerUp={onMessagesListPointerUp}
            rearmScrollDownByUser={rearmScrollDownByUser}
            callIsExpanded={callIsExpanded}
            ...
            jumpHighlightDayId={jumpHighlightDayId}
            appearance={appearance}
            remoteEmojiPlay={remoteEmojiPlay}
            ...
            forceComposerText={forceComposerText}
            setReadersMessage={setReadersMessage}
            loadUserProfile={loadUserProfile}
            onJumpToMessage={onJumpToMessage}
            playAudioFromMessage={playAudioFromMessage}
